(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/js/browser"],{
...
window.bravo_format_money = function ($money) {
  if (!$money) {//return bookingCore.free_text;
...
var cmsHattApp = {
  showSuccess: function showSuccess(configs) {
    ...
    bootbox__WEBPACK_IMPORTED_MODULE_1___default.a.alert(args);
  },
  ...
  showConfirm: function showConfirm(configs) {
    ...
    args.centerVertical = true;
    bootbox__WEBPACK_IMPORTED_MODULE_1___default.a.confirm(args);
  }
};

(function ($) {
  window.uploaderModal = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
    el: '#cdn-browser',
    data: {
      files: [],
      viewType: 'grid',
            ...
            if (result) {
              ...
              $.ajax({
                ...
                success: function success(data) {
                  if (data.status === 1) {// cmsHattApp.showSuccess(data);
                  }
  ...
  vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('file-item', {
...
/***/ 1:
/*!***************************************!*\
  !*** multi ./resources/js/browser.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! F:\Program Files\xampp\htdocs\suntel\cms-music\resources\js\browser.js */"./resources/js/browser.js");
